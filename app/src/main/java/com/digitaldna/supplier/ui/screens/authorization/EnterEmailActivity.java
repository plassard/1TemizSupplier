...
public class EnterEmailActivity extends Activity {
    ...
    private void handleResult(GetLoginBean getLoginBean){
        ...
        Log.i("LLL", "store2 " + loginSupplierBean.toString());
        Log.i("LLL", "store2 " + loginSupplierBean.getTitle());
    ...
    private void connectToServer(){
        LoginRequest loginRequest = new LoginRequest("eozturk782@gmail.com", "123456");
        ...
        retrofit.create(NetworkAPIsInterface.class).login(loginRequest)
                ...
                .subscribe(result -> handleResult(result) , this::handleError);
